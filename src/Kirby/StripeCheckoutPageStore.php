...
final class StripeCheckoutPageStore
{
    ...
    public function settings(): PageSettings
    {
        ...
        return new PageSettings(
            ...
            billingAddressCollection: $this->fieldValue($page, 'billingAddressCollection'),
            individualNameCollection: $this->fieldValue($page, 'individualNameCollection'),
            businessNameCollection: $this->fieldValue($page, 'businessNameCollection'),
            phoneNumberCollection: $this->fieldValue($page, 'phoneNumberCollection'),
